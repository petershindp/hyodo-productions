...
const STAGES = [
	{
		...
		icon: (
			<svg className="process-icon" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
				<path d="M12 20h9"/>
	...
	},
	{
		num: "03",
		title: "Post",
		desc: "Edit, sound and color finished in-house — the look stays the director's.",
		icon: (
			<svg className="process-icon" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" aria-hidden="true">
			...
			<div className="process-inner">
				<div className="process-header">
					...
					<p className="process-tagline">
						One studio carries a film the whole way through — nothing handed
						off, nothing lost.
					</p>
				</div>
