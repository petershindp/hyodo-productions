...
export default function HeroAbout() {
	...
	return (
		<section className="about-preview">
			<div
				className={`about-preview-inner${photos.length === 0 ? " about-preview-inner--centered" : ""}`}
			>
				<div>
					<span className="about-preview-eyebrow">Who we are</span>
					<h2 className="about-preview-heading">
						A story-first studio that{" "}
						{<span className="about-preview-accent">honors</span>} every name it
						works with
					</h2>
					<button
